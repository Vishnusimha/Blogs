...
It exists in small shops.
It exists in homes.
It exists in shared flats.
It exists in medicine cabinets.
It exists in small offices and storage rooms.
...
I wanted to build something lightweight, simple, and easy to understand — something a small business owner, a family, a group of friends, or a small office could start using without feeling overwhelmed.
...
StocKeeper gives small business owners a straightforward way to track stock, expiry dates, low-stock levels, and item movement — so they can act early instead of discovering the damage later.
...
With shared inventory, everyone can see the same stock. The person at the shop does not need to call home. They can simply open the app and see what is low, what is finished, what is expiring soon, and what is already planned.
...
Expiry and manufacturing dates are often printed on the outer packaging. Once the strip is removed, the box is thrown away, or the packaging is torn, that information can disappear. If you buy individual strips from a pharmacy, you may not even have the full packaging in the first place.
...
StocKeeper helps by letting you log medicines with purchase dates, expiry dates, quantities, and alerts. When something is close to expiry, the app can remind you before it becomes a risk.
...
A small office may need to track stationery, cleaning supplies, printer items, pantry stock, cables, tools, or basic equipment.

A shared accommodation space may need to track kitchen items, medicines, household supplies, and cleaning products.

A small business may need to track fast-moving goods, slow-moving items, stock value, expiry dates, and shopping or restocking plans.

Even for personal use, it helps when you want to know what you already have before buying more.
...
Open the app.
Add your stock.
Set quantity, expiry, and low-stock level.
Get notified.
Create a plan.
Shop.
Add purchased items back into stock.
...
The app helps you notice what is low or expiring.
You create a shopping plan.
You buy what you need.
You add purchased items back into stock.
Then your inventory is updated again.
...
A project in your local machine is one thing.
...
I built StocKeeper using Kotlin, Jetpack Compose, Room, Firebase, MVVM, Material 3, and modern Android development practices.
